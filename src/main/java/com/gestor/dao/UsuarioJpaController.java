...
import com.gestor.planillasueldos.exceptions.PreexistingEntityException;
import com.gestor.dto.Usuario;
...
public class UsuarioJpaController implements Serializable {
    ...
    public Usuario findUsuarioYClave(String login, String password) {
        try {
            EntityManager em = getEntityManager();
            Query q = em.createNamedQuery("Usuario.validar");
            q.setParameter("logiUsua", login);
            q.setParameter("passUsua", password);
    ...
    public static void main(String[] args) {
        ...
        Usuario u = usuDAO.findUsuarioYClave("kike", "1234");
        if(u!=null)
